...
public class SalesTicket implements Printable {
    ...
    public String toString() {
        return "SalesTicket [goods=" + goods + ", orderId=" + orderId
                + ", totalGoodsNum=" + totalGoodsNum + ", totalPrice=" + totalPrice + ", actualCollection="
                + actualCollection + ", giveChange=" + giveChange + "]";
    }


    public SalesTicket(List<Goods> goods,  String orderId, String totalGoodsNum,
    ...
    public SalesTicket(List<Goods> goods,  String orderId, String totalGoodsNum, String totalPrice, String actualCollection, String giveChange, Date orderDate) {
        this.goods = goods;
        this.orderId = orderId;
        this.totalGoodsNum = totalGoodsNum;
        this.totalPrice = totalPrice;
